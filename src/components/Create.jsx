...
//   return (
//     <form onSubmit ={AddProductHandler} className=' flex flex-col items-center p-[7%] w-screen h-screen'>
...
//         <div className='w-1/2'>
//          <button
//         className="  border-black border rounded mb-2 px-2 text-blue-600 font-medium " >
//         Add New Product
//       </button></div>
//     </form>
//   );
